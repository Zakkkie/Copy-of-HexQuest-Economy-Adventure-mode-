...
export const GAME_CONFIG = {
  ...
  // Level Progression Table (Index = Level)
  // cost: moves/effort to enter/upgrade
  // growthTime: base seconds to complete level
  // income: coins gained upon completion
  // reqRank: player level required to interact
  LEVELS: {
    0: { cost: 1,  growthTime: 5,  income: 1,   reqRank: 0 },
    1: { cost: 1,  growthTime: 10, income: 5,   reqRank: 0 },
    2: { cost: 2,  growthTime: 15, income: 10,  reqRank: 1 }, // Staircase starts
    ...
    // Soft cap at 7 for standard play, expandable
